        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a target="_blank" href="https://shub6059.github.io">Portfolio Site</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="footer">
                    ...
                    <p class="pull-left" style="font-size: 12px;">Powered by <a target="_blank" href="#"><strong>Pi Dashboard</strong></a> v<?php echo($D['version']) ?>, 
                    </p>
                </div>
            </div>
        </div>
